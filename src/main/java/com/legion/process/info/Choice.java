package com.legion.process.info;
...
import com.legion.process.commons.ConditionDeserializer;
...
/**
 * Class representing a choice rule to be included in a {ChoiceState}. A choice consists of a condition and a state that
 * the
...
public final class Choice {
    ...
    /**
     * @return BuilderAbstract instance to construct a {@link Choice}.
     */
    ...
    /**
     * BuilderAbstract for a {@link Choice}.
     */
    ...
    public static final class Builder implements Buildable<Choice> {
         ...
         *
         * @param conditionBuilder Instance of {@link Builder}. Note that the {State} object is not built until the
    ...
    /**
     * Custom deserializer for {@link Builder}.
     */
    private static class ChoiceDeserializer extends StdDeserializer<Builder> {
        ...
        @Override
        public Builder deserialize(JsonParser jsonParser,
