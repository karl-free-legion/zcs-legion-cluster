...
public final class NumericLessThanOrEqualCondition implements BinaryCondition<String> {
    ...
    private NumericLessThanOrEqualCondition(BuilderAbstract builder) {
        this.variable = builder.variable;
        this.expectedValue = builder.expectedValue;
    }

    /**
     * @return BuilderAbstract instance to construct a {@link NumericLessThanOrEqualCondition}.
     */
    ...
    /**
     * BuilderAbstract for a {@link NumericLessThanOrEqualCondition}.
     */
